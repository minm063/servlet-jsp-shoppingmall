package com.nhnacademy.shoppingmall.controller.mypage.user.delete;
...
@RequestMapping(method = RequestMapping.Method.POST, value = "/mypage/user/deleteAction.do")
public class UserDeletePostController implements BaseController {
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        return "redirect:/mypage/user/delete.do";
    }
}
